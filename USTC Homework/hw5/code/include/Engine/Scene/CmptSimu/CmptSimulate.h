...
namespace Ubpa {
	...
	public:
		...
		void SetTopFix() { CastTo<MassSpring>(primitive)->GetSimu()->SetTopFix(); };
		void SetCornerFix() { CastTo<MassSpring>(primitive)->GetSimu()->SetCornerFix(); };
		void AccInit(){ CastTo<MassSpring>(primitive)->GetSimu()->SetMode(true); };
	private:
