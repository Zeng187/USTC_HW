...
//input: circle center & radius, color, number of particles, initial velocity
{
    ...
    while (i < num) {
        ...
        if (pos.x * pos.x + pos.y * pos.y < radius * radius) {
            particles.push_back(Particle(pos + center, c, velocity,1));
            i++;
        }
    }
}
...
void add_jet() {
    add_object_rectangle(Vec(0.05, 0.49), Vec(0.06, 0.51), 0x87CEFA, 10, Vec(7.0, 0.0));
    add_object_rectangle(Vec(0.94, 0.49), Vec(0.95, 0.51), 0x87CEFA, 10, Vec(-7.0, 0.0));
}
...
int main() {
  ...
  /***********************************(5)*****************************************/
  add_object_circle(Vec(0.15, 0.65), 0.03, 0xF2B134, 1000, Vec(15.0, 0.0));
  add_object_circle(Vec(0.85, 0.75), 0.03, 0xF2B134, 1000, Vec(-15.0, 0.0));
  add_object_circle(Vec(0.15, 0.85), 0.03, 0xF2B134, 1000, Vec(15.0, 0.0));
