...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        transformf lightProjection;
        lightProjection = transformf::perspective(to_radian(120.0f), 1.0f, near_plane, far_plane);
        ...
        transformf pmodel(position_plane, scale_plane);
